...
| Method evidence | M3 | Four disclosed 12-case Antigravity runs: two Gemini and two Claude. All report 12/12 contract passes with the skill vs. 0/12 for the baseline. The first Claude run stores 170 skill warnings under 1.2.2 and the fresh [post-change replication](evals/agent-eval/runs/2026-09-01-antigravity-claude-opus-4.6-thinking-seed-20260902/) stores 111. Ruleset 1.2.3 shows those arms contain 2 and 3 truncated samples respectively, so totals are lower bounds. Exact artifacts, freshness comparisons, triage, and limitations are published. | Add structured-artifact evaluation and broader task domains; practitioner validation remains tracked under U |
