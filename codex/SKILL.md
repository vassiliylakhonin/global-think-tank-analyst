...
description: Codex-ready variant of Policy Risk Memo Architect for decision-ready memos on geopolitics, sanctions, trade, regulation, and strategic risk with explicit uncertainty, competing interpretations, options, and indicators.
---

# Policy Risk Memo Architect

Codex variant: same analytical standard, tuned for direct use in Codex skill workflows.
